...
export default function StatsAndReview() {
    ...
    return (
        <div className="shell ft-shell" style={{ borderRadius: '0' }}>
            <motion.div
                ref={statsRef}
                initial="hidden" animate={statsInView ? "visible" : "hidden"} variants={fadeUp}
                className="flex flex-col lg:flex-row items-stretch lg:items-center gap-12 lg:gap-16 py-0 relative"
            >
                ...
                {/* Stats */}
                <div className="flex flex-wrap lg:flex-nowrap items-center gap-8 lg:gap-16 flex-shrink-0 relative z-10">
                ...
                <blockquote className="flex-1 relative p-8 lg:p-10 rounded-3xl bg-white/[0.02] border border-white/[0.05] shadow-[0_0_50px_rgba(0,0,0,0.5)] backdrop-blur-md overflow-hidden group hover:bg-white/[0.04] transition-colors duration-500 ml-0 lg:ml-8 z-10">
